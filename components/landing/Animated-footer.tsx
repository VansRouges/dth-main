...
export default function AnimatedFooter() {
  ...
  return (
    <footer ref={footerRef} className="bg-white py-28 px-4 border-t border-gray-200">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.div className="p-2 px-3" variants={itemVariants}>
            ...
            >
              {"Don't miss important dates, news, and resources."}
            </motion.p>
            <motion.h3 
          ...
          >
            ...
            <motion.div 
              className="flex flex-col space-y-2 text-gray-700 justify-center items-center"
              initial={{ opacity: 0, y: 20 }}
              animate={footerInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
            ...
            >
              ...
              <motion.div variants={socialIconVariants}>
                <Link href="https://www.linkedin.com/company/datatechhubhq/" className="text-gray-600 hover:text-gray-900 transition-colors">
              ...
              {/* Instagram */}
              <motion.div variants={socialIconVariants}>
                <Link href="https://www.instagram.com/datatechhub.io?igsh=MW9laDhmd3EwdGRuZQ%3D%3D&utm_source=qr" className="text-gray-600 hover:text-gray-900 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Facebook */}
              <motion.div variants={socialIconVariants}>
                <Link href="https://www.facebook.com/share/1AhLUQTbbP/?mibextid=wwXIfr" className="text-gray-600 hover:text-gray-900 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <motion.div className="text-right sm:w-auto mx-auto flex justify-center flex-col" variants={itemVariants}>
            ...
            <motion.div 
              className="flex justify-end gap-4 text-sm text-gray-600"
              initial={{ opacity: 0, y: 20 }}
              animate={footerInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
